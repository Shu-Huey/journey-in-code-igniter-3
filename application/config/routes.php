...
// this is how you pass the parameters (any characters)

$route['blog/(:num)'] = 'PageController/blog/$1'; 
// this is how you pass the parameters (only number for ID purpose)
...
$route['petappt'] = 'Frontend/PetApptController/index';
$route['petappt/add'] = 'Frontend/PetApptController/create';
$route['petappt/store'] = 'Frontend/PetApptController/store';
$route['petappt/edit/(:any)'] = 'Frontend/PetApptController/edit/$1';
$route['petappt/update/(:any)'] = 'Frontend/PetApptController/update/$1';
$route['petappt/delete/(:any)'] = 'Frontend/PetApptController/delete/$1';
